...
// navigation currently hardcoded in the Energy Talent frontend, so the menus
...
const footerContactDetails = [
  {
    ...
    type: "text",
    value:
      "Energy Talent (OPC) Pvt Ltd — your gateway to global opportunities. Travel, document legalization, AI marketing, education and technology solutions across India and 120+ countries.",
  },
  {
    title: "Copyright",
    type: "text",
    value: "© 2026 Energy Talent Logistics. All rights reserved.",
  },
];
