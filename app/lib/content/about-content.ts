...
//
// Mirrors the Energy Talent frontend About page section-for-section, with icons
...
// Icon names exported by Energy Talent/app/components/aboutpage/icons.tsx
...
export function defaultAboutContent(): AboutPageContent {
  return {
    ...
    founder: {
      ...
      quote:
        "True global mobility requires a foundation of absolute legal trust. We built Energy Talent to turn complex international bureaucracies into a secure, flawless day-to-day operation.",
      signature: "Energy Talent",
    },
  };
}

export const ABOUT_META_DEFAULTS = {
  metaTitle: "About Us — Energy Talent",
  metaDescription:
    "Energy Talent is a premium cross-border legal-logistics desk operating alongside the Ministry of External Affairs — 15+ years, 120+ countries, absolute integrity.",
};
