        ...
        <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
          <tr>
            <td style="padding:0 4px 14px;font-size:13px;font-weight:700;color:#e2e8f0;">
              <span style="display:inline-block;width:8px;height:8px;background:#22c55e;border-radius:50%;margin-right:8px;"></span>Energy Talent CMS
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="padding:16px 4px 0;">
              <p style="margin:0 0 6px;font-size:12px;font-weight:600;color:#cbd5e1;letter-spacing:0.02em;">ENERGY TALENT TECHNOLOGIES (OPC) PRIVATE LIMITED</p>
              <p style="margin:0;font-size:11.5px;color:#64748b;line-height:1.6;">You're receiving this because you're listed as an admin contact for Energy Talent CMS.</p>
            </td>
          </tr>
        </table>
      </td></tr>
...
export async function sendOTP(email: string, otp: string) {
    try {
        ...
        const mailOptions = {
            ...
            to: email,
            subject: "Your Energy Talent CMS password reset code",
            html: `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body style="margin:0;padding:0;background:#0b1220;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;color:#f1f5f9;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;font-size:1px;line-height:1px;">
        Your Energy Talent CMS verification code is ${safeOtp}. It expires in 10 minutes.
    </div>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding:32px 36px 4px;">
                                        ...
                                        <p style="margin:12px 0 0;font-size:14px;color:#94a3b8;line-height:1.6;">We received a request to reset the password for your Energy Talent CMS account. Use the one-time code below to continue. If this wasn't you, you can safely ignore this email.</p>
                                    </td>
                                </tr>
                            </table>
                                            ...
                                            <tr>
                                                <td style="padding:14px 16px;">
                                                    <p style="margin:0;font-size:13px;color:#fcd34d;line-height:1.55;">
                                                        <strong style="color:#fde68a;">Don't share this code.</strong> <span style="color:#fbbf24;">Energy Talent staff will never ask for your verification code. If you didn't request a reset, your password will remain unchanged.</span>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
