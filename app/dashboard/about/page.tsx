...
// Energy Talent frontend /about page renders — every section of the live design
            ...
            <div key={i} className={`${cardWrapCls} space-y-3`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <Field label="Email (optional)">
                  <Input className={inputCls} value={m.email ?? ""} placeholder="meera@energytalent.in" onChange={(e) => set("team", { ...team, members: team.members.map((x, idx) => (idx === i ? { ...x, email: e.target.value } : x)) })} />
                </Field>
