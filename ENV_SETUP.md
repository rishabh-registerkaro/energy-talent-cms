...
3. Under **Create a New MySQL Database and Database User**, enter a database name (e.g. `energy_talent_cms`), a username, and a strong password → **Create**.
4. Note the values shown in the database list:
   - **Database name**: e.g. `u698468992_energy_talent_cms` (Hostinger prefixes your account id)
   - **Username**: e.g. `u698468992_energy-talent-cms`
...
6. Assemble the URL:
   ```
   DATABASE_URL="mysql://u698468992_energy-talent-cms:YourPassword@srv1234.hstgr.io:3306/u698468992_energy_talent_cms?connection_limit=5"
   ```
...
```
MONGO_URI=mongodb+srv://user:pass@cluster.mongodb.net/energy-talent-cms-cms
DB_NAME=energy-talent-cms-cms
```
...
5. Under "App name" type anything, e.g. `Energy Talent CMS`.
6. Click **Create**.
...
```
SMTP_FROM="Energy Talent CMS <youraddress@gmail.com>"
```
...
NOTIFY_SMTP_FROM="Energy Talent Alerts <alerts@yourdomain.com>"
```
...
DATABASE_URL="mysql://u000000000_user:password@srv0000.hstgr.io:3306/u000000000_energy_talent_cms?connection_limit=5"

# Only needed while running the one-time Mongo → MySQL data migration:
# MONGO_URI=mongodb+srv://username:password@cluster.mongodb.net/energy-talent-cms-cms
# DB_NAME=energy-talent-cms-cms
